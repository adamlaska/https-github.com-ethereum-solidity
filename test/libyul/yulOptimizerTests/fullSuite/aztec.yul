...
//             case 1 {
//                 kn := addmod(kn, sub(gen_order, k), gen_order)
//                 let x := mod(mload(_1), gen_order)
//                 k := mulmod(k, x, gen_order)
//                 a := mulmod(a, x, gen_order)
//                 c := mulmod(challenge, x, gen_order)
//                 mstore(_1, keccak256(_1, 0x20))
//             }
//             case 0 {
//                 kn := addmod(kn, k, gen_order)
//             }
...
//             mstore(0x60, k)
//             mstore(0xc0, a)
//             let result := call(gas(), 7, _1, 0xe0, 0x60, 0x1a0, _4)
//             let result_1 := and(result, call(gas(), 7, _1, 0x20, 0x60, 0x120, _4))
//             let result_2 := and(result_1, call(gas(), 7, _1, 0x80, 0x60, 0x160, _4))
//             let result_3 := and(result_2, call(gas(), 6, _1, 0x120, 0x80, 0x160, _4))
//             result := and(result_3, call(gas(), 6, _1, 0x160, 0x80, b, _4))
//             if eq(i, m)
//             {
//                 mstore(0x260, mload(0x20))
...
//             {
//                 mstore(0x60, c)
//                 let result_4 := and(result, call(gas(), 7, _1, 0x20, 0x60, 0x220, _4))
//                 let result_5 := and(result_4, call(gas(), 6, _1, 0x220, 0x80, 0x260, _4))
//                 result := and(result_5, call(gas(), 6, _1, 0x1a0, 0x80, 0x1e0, _4))
//             }
//             if iszero(result)
//             {
//                 mstore(_1, 400)
